...
export const stockData = async (tickerSymbol) => {
    try {
        // const responce = await fetch(`https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol=${tickerSymbol}&interval=5min&outputsize=full&apikey=demo`)
        ...
        for (const [key, value] of Object.entries(data["Time Series (5min)"])) {
            ...
            chartData.push({
                ...
                symbole: data["Meta Data"]["2. Symbol"],
            });
